    ...
    <section id="process" className="section bg-mist">
      <div className="container-x">
        ...
        <div className="relative mt-16">
          ...
          <div
            aria-hidden
            className="absolute left-0 right-0 top-7 hidden h-px bg-gradient-to-r from-burgundy/20 via-burgundy/40 to-burgundy/20 lg:block"
          />
            ...
            {PROCESS.map((step, i) => (
              ...
              >
                <div className="relative z-10 flex h-14 w-14 items-center justify-center rounded-full bg-burgundy text-white shadow-cta ring-8 ring-mist">
                  ...
                  <span className="absolute -right-1 -top-1 flex h-6 w-6 items-center justify-center rounded-full bg-onyx text-[11px] font-bold text-white">
                    {step.n}
                  </span>
                </div>
