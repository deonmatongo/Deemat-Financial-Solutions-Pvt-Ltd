...
export default function IndustriesPreview() {
  return (
    <section className="section bg-onyx">
      <div className="container-x">
        <Reveal className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          ...
          <Link
            href="/industries"
            className="inline-flex items-center gap-2 text-sm font-semibold text-burgundy-light hover:text-white"
          >
            Explore industries
          ...
          {INDUSTRIES.map((industry, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-white/10 text-white transition-colors group-hover:bg-burgundy">
